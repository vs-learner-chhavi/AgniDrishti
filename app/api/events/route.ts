...
const demoEvents=[
 {id:'TG-1042',classification:'Industrial Fire',confidence:91,risk:'CRITICAL',source:'DEMO',detectedAt:new Date().toISOString(),latitude:22.31,longitude:72.61,brightnessKelvin:342,persistenceScore:88,persistenceDays:18,persistenceObservations:42,persistenceWindow:30,industrialDistance:0.7,landCover:'industrial'},
