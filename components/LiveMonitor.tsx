...
import evidenceStyles from './ClassificationEvidence.module.css';
import { contribution, factorText, type Factor } from '@/lib/classification-evidence';
